...
3. Descargue Docker para PC:
   https://docs.docker.com/desktop/setup/install/windows-install/
4. Importar el collection compartido por correo electrónico para ejecutar las peticiones.
5. Ejecutar el comando **docker-compose build** el cual creará el contenedor de Docker con el ambiente de C# y el motor de Base de Datos SQL.
6. Ejecutar el comando **docker-compuse up** el cual levantará el contenedor creado.
7. Realizar peticiones al WebService.
